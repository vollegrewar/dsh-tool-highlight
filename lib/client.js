...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS_TEXT = [
      ...
      ".th-head{display:flex;align-items:center;gap:6px;width:100%;padding:6px 10px;font:12px/1.5 ui-monospace,Consolas,'Microsoft YaHei',monospace;color:var(--dsw-alias-foreground,#c9d1d9);border:none;border-bottom:1px solid var(--dsw-alias-border,#30363d);background:var(--dsw-alias-surface-2,#1c2126);cursor:pointer;text-align:left}",
      ...
      ".th-settings-header{display:flex;align-items:center;gap:8px;width:100%;padding:8px 10px;background:none;border:none;color:var(--dsw-alias-foreground,#c9d1d9);font:600 13px/1.4 system-ui,'Microsoft YaHei',sans-serif;cursor:pointer;text-align:left}",
      ...
      ".th-settings-label{flex:none;font:600 12.5px/1.5 system-ui,'Microsoft YaHei',sans-serif}",
      ".th-settings-hint{flex:1;font:11.5px/1.5 system-ui,'Microsoft YaHei',sans-serif;color:#8b949e}",
      ".th-settings-switch{flex:none;position:relative;width:32px;height:18px;border-radius:9px;border:none;background:var(--dsw-alias-border,#30363d);cursor:pointer;transition:background .15s ease}",
      ...
      ".th-settings-status{font:11.5px/1.5 system-ui,'Microsoft YaHei',sans-serif;color:#8b949e}",
    ].join("\n");
    ...
    function useCollapseByDefault() {
      ...
      React.useEffect(function () {
        ...
        return settingsScopeRef.subscribe(function () { st[1](readCollapseByDefault()); });
      }, []);
      return st[0];
    }
    ...
    function ToolHighlightSettingsRow(props) {
      ...
      var snapshot = props.useToolHighlight(function (s) { return s; });
        ...
        open && e("div", { className: "th-settings-body" },
          snapshot.status !== "ready"
            ...
            : e("div", { className: "th-settings-row" },
                ...
                e("button", { type: "button", id: "tool-highlight-collapse-default", className: "th-settings-switch" + (collapseOn ? " on" : ""), "aria-pressed": collapseOn ? "true" : "false", disabled: disabled, onClick: function () { props.setCollapseByDefault(!collapseOn); } },
